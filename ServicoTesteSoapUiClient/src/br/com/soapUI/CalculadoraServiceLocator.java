...
public class CalculadoraServiceLocator extends org.apache.axis.client.Service implements br.com.soapUI.CalculadoraService {
    ...
    private java.lang.String Calculadora_address = "http://localhost:8080/ServicoTesteSoapUi/services/Calculadora";
    ...
    public br.com.soapUI.Calculadora getCalculadora(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.soapUI.CalculadoraSoapBindingStub _stub = new br.com.soapUI.CalculadoraSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.soapUI.Calculadora.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.soapUI.CalculadoraSoapBindingStub _stub = new br.com.soapUI.CalculadoraSoapBindingStub(new java.net.URL(Calculadora_address), this);
                _stub.setPortName(getCalculadoraWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapUI.com.br", "CalculadoraService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapUI.com.br", "Calculadora"));
        }
